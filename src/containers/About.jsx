        ...
        <section className="py-6">
          <div className="container p-4 mx-auto space-y-16 sm:p-10">
            <div className="space-y-4">
              <h3 className="text-2xl leading-none font_titulos sm:text-4xl">Nuestro Team</h3>
              <p className="max-w-2xl dark:text-gray-400">At a assumenda quas cum earum ut itaque commodi saepe rem </p>
            </div>
