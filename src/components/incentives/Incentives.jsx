...
export default function Incentives() {
  ...
  return (
    <div className="">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-4 mx-auto w-full md:max-w-[1270px] mt-6">
        <div className=" h-auto md:h-[300px] p-4 flex items-center justify-center mx-auto">
          <h2 className="text-2xl md:text-3xl font_titulos">¿Por qué elegir la agencia de productos digitales emaart? </h2>
        </div>
        <div className="flex items-center justify-center w-full p-4 mx-auto md:w-2/3 lg:col-span-2">
