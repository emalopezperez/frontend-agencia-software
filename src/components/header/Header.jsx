...
import img from "../../../public/bg-home/bg-home.jpg"
...
const Header = ({ typewriter, text, descripcion }) => {
  return (
    <header>
      <Image
            ...
            <div>
...

              {
                typewriter ? <div className="flex-col max-w-xl md:max-w-3xl  md:gap-4 text-[14px] leading-8 text-black xl:text-md ">
                  ...
                  <span className='mx-1 font-medium leading-8 text-gray-700 transition duration-300 ease-in-out transform border-b-2 border-transparent cursor-pointer text-md sm:text-center hover:border-orange-500 hover:scale-90'><Link href='/'> Digital Marketing</Link></span>
                </div>
                  :
                  <p className="max-w-[750px] font_text">
                    { descripcion }
                  </p>
              }
