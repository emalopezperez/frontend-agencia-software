  ...
  return (
    <nav>
      <div
        ...
        <div className="max-w-[1240px] lg:flex justify-between mx-auto hidden">
          <div
        ...
        <div
          ...
          <div
              ...
              >
                <div className={ iconClass }>
                  { isHovering ? (
                    ...
                    <FaLaptopCode className="text-white text-md" />
                  ) }
                </div>
                <h2 className="text-white transition duration-300 ease-in-out transform cursor-pointer text-md eading-6 hover:text-orange-400 hover:scale-90">Icon</h2>
              </div>
              <div
                onClick={ handleNav }
            ...
            <div className="pt-6 my-4 border-b border-gray-300">
              <p className="text-white text-md font_titulos">
                Tu mejor opcion
              </p>
            </div>

            <div className="flex flex-col py-4 pt-4 text-white">
            ...
            <div className="flex pb-4 mx-auto mt-8 space-x-5">
              { navigation.social.map((item) => (
                <a key={ item.name } href={ item.href } className="text-white">
                  <span className="sr-only">{ item.name }</span>
                  <item.icon className="w-6 h-6 transition duration-300 ease-in-out transform cursor-pointer hover:text-orange-500 hover:scale-90" aria-hidden="true" />
                </a>
              )) }
            </div>
          </div>
        ...
        <div className="flex justify-between mx-8 text-black aling-center lg:hidden sm:flex-nowrap">
