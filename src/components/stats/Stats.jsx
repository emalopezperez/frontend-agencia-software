...
const Stats = () => {
  return (
    <section className="flex justify-center p-4 my-6 mt-20 mb-40 md:p-8 dark:text-gray-100 bg-[#f3f3f3]">
	<div className="container grid grid-cols-1 gap-6 m-4 md:m-0 md:grid-cols-2 xl:grid-cols-3 max-w-[1210px] mx-auto">
